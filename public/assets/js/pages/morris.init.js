!function (e) {
    ...
    a.prototype.createLineChart = function (e, a, r, t, o, i, b, s, y) {
        Morris.Line({
            element: e,
            data: a,
            xkey: r,
    ...
    }, a.prototype.createAreaChart = function (e, a, r, t, o, i, b, s) {
        Morris.Area({
            element: e,
            pointSize: 0,
            lineWidth: 0,
    ...
    }, a.prototype.createAreaChartDotted = function (e, a, r, t, o, i, b, s, y, l) {
        Morris.Area({
            element: e,
            pointSize: 3,
            lineWidth: 1,
        ...
        this.createAreaChart("morris-area-example", 0, 0, [{y: "2009", a: 10, b: 20}, {
            y: "2010",
            a: 75,
            b: 65
            ...
            a: 75,
            b: 65
        }, {y: "2015", a: 90, b: 60}], "y", ["a", "b"], ["Series A", "Series B"], ["#5b69bc", "#35b8e0"]);
        this.createAreaChartDotted("morris-area-with-dotted", 0, 0, [{y: "2009", a: 10, b: 20}, {
            y: "2010",
            a: 75,
            b: 65
        }, {y: "2011", a: 50, b: 40}, {y: "2012", a: 75, b: 65}, {y: "2013", a: 50, b: 40}, {
        ...
        this.createBarChart("morris-bar-example", [{y: "2009", a: 100, b: 90, c: 40}, {
            y: "2010",
            a: 75,
            b: 65,
            c: 20
        }, {y: "2011", a: 50, b: 40, c: 50}, {y: "2012", a: 75, b: 65, c: 95}, {
            y: "2013",
            a: 50,
            b: 40,
            c: 22
        ...
        this.createStackedChart("morris-bar-stacked", [{y: "2005", a: 45, b: 180}, {
            ...
            a: 75,
            b: 65
        }, {y: "2015", a: 100, b: 90}], "y", ["a", "b"], ["Series A", "Series B"], ["#71b6f9", "#ebeff2"]);
