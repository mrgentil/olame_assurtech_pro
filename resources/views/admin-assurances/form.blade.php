<form action="{{ isset($action) && $action ===  'POST' ?  route('admin-assurances.store') :  route('admin-assurances.update', $admin) }}"
    ...
    <div class="form-group col-md-12">
        <label for="entreprise_assurance_id" class="col-form-label">Entreprise</label>
        <select id="entreprise_assurance_id"  value="{{ (old('entreprise_assurance_id')) ? old('entreprise_assurance_id') : ((isset($admin) ? $admin->entreprise_assurance_id : '')) }}" name="entreprise_assurance_id" class="form-control select2-results__option @error('entreprise_assurance_id') is-invalid @enderror">
