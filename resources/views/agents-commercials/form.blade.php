<form action="{{ isset($action) && $action ===  'POST' ?  route('agents-commercials.store') :  route('agents-commercials.update', $admin) }}"
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" value="{{ (old('ville')) ? old('ville') : ((isset($admin) ? $admin->ville : '')) }}" name="ville" class="form-control @error('ville') is-invalid @enderror" id="ville" placeholder="Ville" required="required">
            @error('ville')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" value="{{ (old('agence')) ? old('agence') : ((isset($admin) ? $admin->agence : '')) }}" name="agence" class="form-control @error('agence') is-invalid @enderror" id="agence" placeholder="Agence" required="required">
            @error('agence')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
