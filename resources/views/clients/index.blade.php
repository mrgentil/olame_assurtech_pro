                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            @can('AdminEntrepriseAssurance')
                                                                <a href="{{route('clients.edit',$item)}}" class="mr-1 shadow btn btn-primary btn-xs sharp"><i class="fa fa-edit"></i></a>
                                                            @endcan
                                                            @can('AdminEntrepriseAssurance')
                                                                <form id="{{$item->id}}" action="{{route('$clients.destroy', $item)}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
